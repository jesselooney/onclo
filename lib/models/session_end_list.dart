...
// 1. _sessionEnds[i].endDate <= _sessionEnds[i + 1].endDate for all 0 <= i < _sessionEnds.length - 1
class SessionEndList extends ChangeNotifier {
  final List<SessionEnd> _sessionEnds = [];

  UnmodifiableListView<Session> get sessionEnds => UnmodifiableListView(_sessionEnds);
